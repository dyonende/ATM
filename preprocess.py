...
for i in range(len(in_data)):
    ...
    print(token_list[i], lemma_list[i], upos_list[i], xpos_list[i], deprel_list[i], head_list[i], prev_token, prev_pos, next_token, next_pos, negation_prefix, negation_postfix, in_NegExpList, in_data[i][4], sep='\t')  
