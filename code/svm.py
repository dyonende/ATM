...
def create_classifier(train_features, train_targets, modelname):
    """
    Function creates and trains a classifier based on a set of training 
    features and gold labels to the trainingdata, classifier can ben specified.
    """
    if modelname == 'SVM':
